      ...
      <div className="absolute inset-x-0 top-10 mx-auto max-w-4xl bg-white rounded-lg shadow-xl border">
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
            ...
            <input type="date" className="px-3 py-2 border rounded" value={from} onChange={(e) => setFrom(e.target.value)} placeholder={t('from')} />
            <input type="date" className="px-3 py-2 border rounded" value={to} onChange={(e) => setTo(e.target.value)} placeholder={t('to')} />
            <div className="grid grid-cols-2 gap-2">
              <input className="px-3 py-2 border rounded" placeholder="patientId" value={patientId} onChange={(e) => setPatientId(e.target.value)} />
              <input className="px-3 py-2 border rounded" placeholder="doctorId" value={doctorId} onChange={(e) => setDoctorId(e.target.value)} />
            </div>
          </div>
