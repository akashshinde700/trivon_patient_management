        ...
        <div class="prescription-container">
          ...
          <div class="header">
            ...
            <div class="clinic-details">
              ${clinicData?.address || 'Healthcare Avenue, Medical District'}<br>
              ${clinicData?.city || 'Mumbai'}, ${clinicData?.state || 'Maharashtra'} - ${clinicData?.pincode || '400001'}<br>
              Phone: ${clinicData?.phone || '+91-8530345858'} | Email: ${clinicData?.email || 'clinic@eka.care'}
            </div>
          </div>

          <!-- Doctor Info -->
          <div class="doctor-info">
            <div class="doctor-name">Dr. ${doctorData?.name || 'Rajesh Kumar'}</div>
            <div class="doctor-details">
              ${doctorData?.qualification || 'MBBS, MD'} | ${doctorData?.specialization || 'General Medicine'}<br>
              License: ${doctorData?.license_number || 'MCI123456'} | Experience: ${doctorData?.experience_years || 15} years
            </div>
          </div>
          ...
          <div class="patient-info">
            <div class="patient-details">
              ...
              <div class="info-row">
                ...
                <span class="info-value">${patientData?.phone || '+91-8530345858'}</span>
              </div>
            </div>
        ...
        <div class="receipt-container">
          ...
          <div class="payment-info">
            <div class="info-row">
              ...
              <span class="info-value">${receiptData?.payment_mode || 'Cash'}</span>
            </div>
            <div class="info-row">
              <span class="info-label">Amount Paid:</span>
              <span class="info-value">₹${receiptData?.amount_paid || totalAmount}</span>
            </div>
          ...
          <div class="footer">
            ...
            <p>For any queries, please contact: ${clinicData?.phone || '+91-8530345858'}</p>
          </div>
        </div>
      </body>
      </html>
