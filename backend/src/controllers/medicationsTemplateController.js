...
const getAllTemplates = async (req, res) => {
  try {
    ...
    const parsedTemplates = templates.map(template => ({
      ...template,
      medications: typeof template.medications === 'string'
...
const getTemplateById = async (req, res) => {
  try {
    ...
    const template = {
      ...templates[0],
      medications: typeof templates[0].medications === 'string'
        ? JSON.parse(templates[0].medications)
        : templates[0].medications
    };
